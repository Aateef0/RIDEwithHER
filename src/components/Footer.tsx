      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <img src="/logo.png" alt="RIDEwithHER Logo" className="h-10 w-10 object-contain bg-white rounded-full p-1" />
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a
                href="mailto:ridewithher.service@gmail.com"
                className="flex items-center gap-3 text-sm text-purple-200 hover:text-white transition-colors"
              >
                <Mail className="h-5 w-5" />
                <span>ridewithher.service@gmail.com</span>
              </a>
            </div>
        ...
        <div className="border-t border-purple-700 pt-8">
          <p className="text-center text-sm text-purple-300">
            © 2026 RIDEwithHER. All rights reserved. | Women-only ride service | Indore, India
          </p>
        </div>
      </div>
    </footer>
